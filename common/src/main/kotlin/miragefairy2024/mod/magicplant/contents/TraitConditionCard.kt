...
enum class TraitConditionCard(
    ...
    LIGHT("light", Emoji.LIGHT, "Light", "光", { world, blockPos, _ -> (world.getMaxLocalRawBrightness(blockPos) - 8 atLeast 0) / 7.0 }),
    DARKNESS("darkness", Emoji.DARKNESS, "Darkness", "闇", { world, blockPos, _ -> ((15 - world.getMaxLocalRawBrightness(blockPos)) - 8 atLeast 0) / 7.0 }),
    ...
    SUNSHINE_ENVIRONMENT("sunshine_environment", Emoji.OUTDOOR, "Sunshine Environment", "日照環境", { world, blockPos, _ -> world.getBrightness(LightLayer.SKY, blockPos) / 15.0 }),
