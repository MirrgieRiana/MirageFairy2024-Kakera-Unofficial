...
class ToolCard(
    ...
    companion object {
        ...
        val TOPAZ = toolSet("topaz", "トパーズ", ToolMaterialCard.TOPAZ, MaterialCard.TOPAZ.item) { it.enchantment(Enchantments.FIRE_ASPECT).enchantment(Enchantments.SHARPNESS, 3) }
