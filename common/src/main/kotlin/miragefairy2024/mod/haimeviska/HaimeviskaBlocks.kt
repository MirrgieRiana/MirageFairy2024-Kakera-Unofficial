...
class HaimeviskaBlockCard(
    ...
    companion object {
        ...
        val LEAVES = !HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { HaimeviskaLeavesBlock(createLeavesSettings()) }, ::initLeavesHaimeviskaBlock) {
        ...
        val LOG = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { HaimeviskaLogBlock(createLogSettings()) }, initLogHaimeviskaBlock(null)) {
        ...
        val WOOD = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { PillarBlock(createLogSettings(wood = true)) }, initLogHaimeviskaBlock({ LOG }, wood = true)) {
                block.registerDefaultLootTableGeneration()
        ...
        val STRIPPED_LOG = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { PillarBlock(createLogSettings(stripped = true)) }, initLogHaimeviskaBlock(null, stripped = true)) {
                block.registerDefaultLootTableGeneration()
        ...
        val STRIPPED_WOOD = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { PillarBlock(createLogSettings(stripped = true, wood = true)) }, initLogHaimeviskaBlock({ STRIPPED_LOG }, stripped = true, wood = true)) {
                block.registerDefaultLootTableGeneration()
                registerShapedRecipeGeneration(item, 3) {
                    pattern("##")
                    pattern("##")
        ...
        val INCISED_LOG = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { IncisedHaimeviskaLogBlock(createSpecialLogSettings()) }, ::initHorizontalFacingLogHaimeviskaBlock) {
        ...
        val DRIPPING_LOG = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { DrippingHaimeviskaLogBlock(createSpecialLogSettings()) }, ::initHorizontalFacingLogHaimeviskaBlock) {
        ...
        val HOLLOW_LOG = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { HollowHaimeviskaLogBlock(createSpecialLogSettings()) }, ::initHorizontalFacingLogHaimeviskaBlock) {
                block.registerLootTableGeneration { provider, registries ->
                    LootTable(
                        LootPool(ItemLootPoolEntry(item())) {
                            `when`(provider.hasSilkTouch())
        ...
        val PLANKS = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { Block(createPlankSettings()) }, ::initPlanksHaimeviskaBlock) {
                block.registerDefaultLootTableGeneration()
        ...
        val SLAB = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { SlabBlock(createPlankSettings()) }, ::initPlanksSlabHaimeviskaBlock) {
        ...
        val STAIRS = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { StairBlock(PLANKS.block.await().defaultBlockState(), createPlankSettings()) }, ::initPlanksStairsHaimeviskaBlock) {
        ...
        val FENCE = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { FenceBlock(createPlankSettings()) }, ::initPlanksFenceHaimeviskaBlock) {
        ...
        val FENCE_GATE = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { FenceGateBlock(HAIMEVISKA_WOOD_TYPE, createPlankSettings(sound = false).forceSolidOn()) }, ::initPlanksFenceGateHaimeviskaBlock) {
        ...
        val BUTTON = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { ButtonBlock(HAIMEVISKA_BLOCK_SET_TYPE, 30, AbstractBlock.Properties.of().noCollission().strength(0.5F).pushReaction(PistonBehavior.DESTROY)) }, ::initPlanksButtonHaimeviskaBlock) {
        ...
        val PRESSURE_PLATE = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { PressurePlateBlock(HAIMEVISKA_BLOCK_SET_TYPE, createBaseWoodSetting(sound = false).forceSolidOn().noCollission().strength(0.5F).pushReaction(PistonBehavior.DESTROY)) }, ::initPlanksPressurePlateHaimeviskaBlock) {
        ...
        val BRICKS_STAIRS = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { StairBlock(BRICKS.block.await().defaultBlockState(), createPlankSettings()) }, ::initPlanksStairsHaimeviskaBlock) {
        ...
        val SAPLING = HaimeviskaBlockConfiguration(
            ...
            HaimeviskaBlockCard(it, { SaplingBlock(createTreeGrower(MirageFairy2024.identifier("haimeviska_sapling")), createSaplingSettings()) }, ::initSaplingHaimeviskaBlock) {
                block.registerDefaultLootTableGeneration()
                item.registerComposterInput(0.3F)
            }
        }
