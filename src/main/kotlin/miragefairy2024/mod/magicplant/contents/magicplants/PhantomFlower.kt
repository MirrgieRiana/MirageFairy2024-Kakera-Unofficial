...
object PhantomFlowerSettings : SimpleMagicPlantSettings<PhantomFlowerCard, PhantomFlowerBlock>() {
    ...
    val PHANTOM_CLUSTER_CONFIGURED_FEATURE_KEY: RegistryKey<ConfiguredFeature<*, *>> = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier(MirageFairy2024.modId, "phantom_cluster"))
    val PHANTOM_CLUSTER_PLACED_FEATURE_KEY: RegistryKey<PlacedFeature> = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier(MirageFairy2024.modId, "phantom_cluster"))
