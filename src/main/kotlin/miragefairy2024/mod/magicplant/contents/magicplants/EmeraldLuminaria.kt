...
object EmeraldLuminariaConfiguration : SimpleMagicPlantConfiguration<EmeraldLuminariaCard, EmeraldLuminariaBlock>() {
    ...
    override fun createBlock() = EmeraldLuminariaBlock(createCommonSettings().strength(0.2F).luminance { getLuminance(it.getOr(BlockStateProperties.AGE_3) { 0 }) }.mapColor(MapColor.EMERALD_GREEN).sounds(BlockSoundGroup.CROP))
