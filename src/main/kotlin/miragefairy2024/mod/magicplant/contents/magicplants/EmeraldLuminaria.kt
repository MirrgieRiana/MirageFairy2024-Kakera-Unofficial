...
object EmeraldLuminariaSettings : SimpleMagicPlantSettings<EmeraldLuminariaCard, EmeraldLuminariaBlock>() {
    ...
    val EMERALD_LUMINARIA_CLUSTER_CONFIGURED_FEATURE_KEY: RegistryKey<ConfiguredFeature<*, *>> = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier(MirageFairy2024.modId, "emerald_luminaria_cluster"))
    val EMERALD_LUMINARIA_CLUSTER_PLACED_FEATURE_KEY: RegistryKey<PlacedFeature> = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier(MirageFairy2024.modId, "emerald_luminaria_cluster"))
    val UNDERGROUND_EMERALD_LUMINARIA_CLUSTER_PLACED_FEATURE_KEY: RegistryKey<PlacedFeature> = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier(MirageFairy2024.modId, "underground_emerald_luminaria_cluster"))
