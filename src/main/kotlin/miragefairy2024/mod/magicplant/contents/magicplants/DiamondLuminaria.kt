...
object DiamondLuminariaSettings : SimpleMagicPlantSettings<DiamondLuminariaCard, DiamondLuminariaBlock>() {
    ...
    override fun getRareDrops(count: Int, random: Random): List<ItemStack> = listOf(Items.DIAMOND.createItemStack(count))
    ...
    val DIAMOND_LUMINARIA_CLUSTER_CONFIGURED_FEATURE_KEY: RegistryKey<ConfiguredFeature<*, *>> = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier(MirageFairy2024.modId, "diamond_luminaria_cluster"))
    val DIAMOND_LUMINARIA_CLUSTER_PLACED_FEATURE_KEY: RegistryKey<PlacedFeature> = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier(MirageFairy2024.modId, "diamond_luminaria_cluster"))
    ...
    override fun init() {
        ...
        registerDynamicGeneration(DIAMOND_LUMINARIA_CLUSTER_PLACED_FEATURE_KEY) {
            ...
            it.getRegistryLookup(RegistryKeys.CONFIGURED_FEATURE).getOrThrow(DIAMOND_LUMINARIA_CLUSTER_CONFIGURED_FEATURE_KEY) with placementModifiers
        }
