...
class TraitCard(
    ...
    companion object {
        ...
        val PHOTOSYNTHESIS = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.LIGHT), TraitEffectKeyCard.NUTRITION,
        )
        val PHAEOSYNTHESIS = !TraitCard(
            "phaeosynthesis", "Phaeosynthesis", "闇合成",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.DARKNESS), TraitEffectKeyCard.NUTRITION,
        )
        val OSMOTIC_ABSORPTION = !TraitCard(
            "osmotic_absorption", "Osmotic Absorption", "浸透吸収",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.FLOOR_MOISTURE), TraitEffectKeyCard.NUTRITION,
        )
        val CRYSTAL_ABSORPTION = !TraitCard(
            "crystal_absorption", "Crystal Absorption", "鉱物吸収",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.FLOOR_CRYSTAL_ERG), TraitEffectKeyCard.NUTRITION,
        )
        ...
        val COLD_ADAPTATION = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.LOW_TEMPERATURE), TraitEffectKeyCard.ENVIRONMENT,
        )
        val WARM_ADAPTATION = !TraitCard(
            "warm_adaptation", "Warm Adaptation", "温暖適応",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.MEDIUM_TEMPERATURE), TraitEffectKeyCard.ENVIRONMENT,
        )
        val HOT_ADAPTATION = !TraitCard(
            "hot_adaptation", "Hot Adaptation", "熱帯適応",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.HIGH_TEMPERATURE), TraitEffectKeyCard.ENVIRONMENT,
        )
        val ARID_ADAPTATION = !TraitCard(
            "arid_adaptation", "Arid Adaptation", "乾燥適応",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.LOW_HUMIDITY), TraitEffectKeyCard.ENVIRONMENT,
        )
        val MESIC_ADAPTATION = !TraitCard(
            "mesic_adaptation", "Mesic Adaptation", "中湿適応",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.MEDIUM_HUMIDITY), TraitEffectKeyCard.ENVIRONMENT,
        )
        val HUMID_ADAPTATION = !TraitCard(
            "humid_adaptation", "Humid Adaptation", "湿潤適応",
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.HIGH_HUMIDITY), TraitEffectKeyCard.ENVIRONMENT,
        )
        ...
        val DESERT_GEM = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.LOW_HUMIDITY), TraitEffectKeyCard.PRODUCTION_BOOST,
        )
        ...
        val FLESHY_LEAVES = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.LOW_HUMIDITY), TraitEffectKeyCard.LEAVES_PRODUCTION,
        )
        ...
        val CARNIVOROUS_PLANT = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.OUTDOOR), TraitEffectKeyCard.NUTRITION,
        )
        ...
        val PAVEMENT_FLOWERS = !TraitCard(
            ...
            "TODO", // TODO
            "TODO", // TODO
            listOf(TraitFactorCard.FLOOR_HARDNESS), TraitEffectKeyCard.NUTRITION,
        )
    ...
    val trait: Trait = CompoundTrait(traitFactorCards.map { it.traitFactor }, traitEffectKeyCard)

    private class CompoundTrait(private val factors: List<TraitFactor>, private val traitEffectKeyCard: TraitEffectKeyCard) : Trait(traitEffectKeyCard.color) {
