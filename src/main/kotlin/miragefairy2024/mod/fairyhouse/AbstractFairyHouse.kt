...
open class AbstractFairyHouseCard<E : AbstractFairyHouseBlockEntity<E>, H : AbstractFairyHouseScreenHandler>(
    path: String,
    ...
    val guiWidth: Int,
    val guiHeight: Int,
    val blockEntitySettings: AbstractFairyHouseBlockEntity.Settings<E>,
) {
...
open class AbstractFairyHouseBlock(val cardGetter: () -> AbstractFairyHouseCard<*, *>, settings: Settings) : SimpleHorizontalFacingBlock(settings), BlockEntityProvider {
...
abstract class AbstractFairyHouseBlockEntity<E : AbstractFairyHouseBlockEntity<E>>(
    ...
    class Settings<E : AbstractFairyHouseBlockEntity<E>>(val slots: List<SlotSettings> = listOf(), val properties: List<PropertySettings<E>> = listOf()) {
    ...
    class PropertySettings<in E : AbstractFairyHouseBlockEntity<*>>(val getter: E.() -> Int, val setter: E.(Int) -> Unit)
    ...
    override fun createScreenHandler(syncId: Int, playerInventory: PlayerInventory): AbstractFairyHouseScreenHandler {
        val arguments = AbstractFairyHouseScreenHandler.Arguments(
            syncId,
            playerInventory,
            this,
...
open class AbstractFairyHouseScreenHandler(val card: AbstractFairyHouseCard<*, *>, val arguments: Arguments) : ScreenHandler(card.screenHandlerType, arguments.syncId) {
