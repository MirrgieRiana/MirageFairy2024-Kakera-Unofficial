...
abstract class FairyLogisticsBlockEntity<E : FairyLogisticsBlockEntity<E>>(private val card: FairyLogisticsCard<*, E, *>, pos: BlockPos, state: BlockState) : MachineBlockEntity<E>(card, pos, state) {
