...
class FairyAxeItem(override val fairyToolSettings: FairyToolSettings<FairyAxeItem>, settings: Settings) :
    AxeItem(fairyToolSettings.toolMaterialCard.toolMaterial, fairyToolSettings.attackDamage, fairyToolSettings.attackSpeed, settings),
    FairyToolItem<FairyAxeItem>,
