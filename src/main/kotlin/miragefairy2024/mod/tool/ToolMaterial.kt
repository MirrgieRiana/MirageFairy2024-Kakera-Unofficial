...
enum class FairyToolMaterials(
    ...
    LUMINITE(MiningLevels.DIAMOND, 2146, 10.0F, 4.0F, 9, MaterialCard.LUMINITE.item.toIngredient()),
    RESONITE(MiningLevels.NETHERITE, 4465, 7.0F, 5.0F, 14, MaterialCard.RESONITE_INGOT.item.toIngredient()),
