...
class ToolCard(
    ...
    fun init() {
        ...
        val poemList = PoemList(tier).poem(poem).let { configuration.appendPoems(it) }
...
object ToolCards {
    ...
    val IRON_SCYTHE = !ToolCard(
        "iron_scythe", 2, EnJa("Iron Scythe", "鉄の大鎌"),
        EnJa("For cutting grass and harvesting crops.", "草や農作物を刈り取るための道具。"),
    ...
    val DIAMOND_SCYTHE = !ToolCard(
        "diamond_scythe", 3, EnJa("Diamond Scythe", "ダイヤモンドの大鎌"),
        EnJa("A highly durable scythe made of diamond.", "ダイヤモンドを加工した高耐久の大鎌。"),
