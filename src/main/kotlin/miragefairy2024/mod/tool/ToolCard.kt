...
class ToolCard(
    ...
    companion object {
        ...
        val LUMINITE_PICKAXE = !ToolCard(
            ...
            FairyPickaxeConfiguration(ToolMaterialCard.LUMINITE).enchantment(Enchantments.BLOCK_EFFICIENCY, 4).enchantment(Enchantments.FORTUNE, 3),
        ...
        val LUMINITE_AXE = !ToolCard(
            ...
            FairyAxeConfiguration(ToolMaterialCard.LUMINITE, 5.0F, -3.0F).enchantment(Enchantments.BLOCK_EFFICIENCY, 4).enchantment(Enchantments.FORTUNE, 3),
