...
abstract class ReiCategoryCard<D : BasicDisplay>(
    ...
    val translation = Translation({ "category.rei.${MirageFairy2024.MOD_ID}.$path" }, enName, jaName)
...
val COMMON_MOTIF_RECIPE_ALWAYS_TRANSLATION = Translation({ "gui.${MirageFairy2024.MOD_ID}.common_motif_recipe.always" }, "Always", "常時")
