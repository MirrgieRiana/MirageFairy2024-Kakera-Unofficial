...
object FairyCollectorCard : FairyFactoryCard<FairyCollectorBlock, FairyCollectorBlockEntity, FairyCollectorScreenHandler>() {
    ...
    override fun createSlotConfigurations(): List<FairyBuildingSlotConfiguration> {
        ...
        return super.createSlotConfigurations() + listOf(
            ...
            FairyBuildingSlotConfiguration(37 + 18 * 0, 17 + 18 * 0, animation = ac(false, p(11.5, 1.5, 2.5, 0.0F, 180.0F, 200))), // 机
            FairyBuildingSlotConfiguration(81, 35, animation = ac(true, buildList {
                this += p(11.5, 0.1, 6.0, 0.0F, 90.0F, 40)
                this += p(7.0, 0.1, 8.0, 0.0F, 275.0F, 40)
                this += p(12.0, 0.1, 8.0, 0.0F, 265.0F, 40)
                this += p(8.0, 0.1, 6.0, 0.0F, 20.0F, 40)
            })) { it.isOf(FairyCard.item) }, // 仕分け妖精
            FairyBuildingSlotConfiguration(106 + 18 * 0, 26 + 18 * 0, extractDirections = extractDirections, animation = ac(false, p(4.0, 2.0, 4.5, 0.0F, 270.0F, 200))), // 箱
