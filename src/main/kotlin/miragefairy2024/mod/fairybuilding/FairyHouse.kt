...
object FairyHouseCard : FairyFactoryCard<FairyHouseBlock, FairyHouseBlockEntity, FairyHouseScreenHandler>() {
    ...
    override fun createSlotConfigurations(): List<FairyBuildingSlotConfiguration> {
        return super.createSlotConfigurations() + listOf(
            ...
            FairyBuildingSlotConfiguration(61, 17, animation = ac(FAIRY, p(4.5, 2.2, 14.0, 90.0F, 270.0F, 200.0))) { it.isOf(FairyCard.item) }, // ベッド
            FairyBuildingSlotConfiguration(61, 41, animation = ac(FAIRY, p(4.5, 7.2, 14.0, 90.0F, 270.0F, 200.0))) { it.isOf(FairyCard.item) }, // ベッド
            FairyBuildingSlotConfiguration(61, 65, animation = ac(FAIRY, p(4.5, 12.2, 14.0, 90.0F, 270.0F, 200.0))) { it.isOf(FairyCard.item) }, // ベッド
            FairyBuildingSlotConfiguration(82, 48, animation = ac(NONE, p(1.5, 5.5, 2.0, 0.0F, 270.0F, 200.0))), // タンスの上
            FairyBuildingSlotConfiguration(104, 27, animation = ac(FAIRY, p(12.0, 0.1, 3.0, 0.0F, 280.0F, 200.0))) { it.isOf(FairyCard.item) }, // テーブル
            FairyBuildingSlotConfiguration(128, 17, animation = ac(NONE, p(11.5, 1.5, 7.5, 0.0F, 270.0F, 200.0))), // テーブルの上
            FairyBuildingSlotConfiguration(152, 17, animation = ac(FAIRY, p(13.0, 0.1, 12.0, 0.0F, 70.0F, 200.0))) { it.isOf(FairyCard.item) }, // テーブル
            FairyBuildingSlotConfiguration(152, 37, animation = ac(FAIRY, p(9.0, 0.1, 12.0, 0.0F, 110.0F, 200.0))) { it.isOf(FairyCard.item) }, // テーブル
