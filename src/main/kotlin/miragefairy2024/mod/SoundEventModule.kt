...
enum class SoundEventCard(val path: String, en: String, ja: String, soundPaths: List<String>) {
    ...
    ENTITY_PSYCHIC_UNGUIDED_BOLT_HIT("entity.psychic_unguided_bolt.hit", "Psychic Unguided Bolt hits", "サイキック無誘導弾が当たる", listOf("entity_psychic_unguided_bolt_hit_1")),
    ENTITY_PSYCHIC_UNGUIDED_BOLT_SHOOT("entity.psychic_unguided_bolt.shoot", "Psychic Unguided Bolt fired", "サイキック無誘導弾が発射される", listOf("entity_psychic_unguided_bolt_shoot_1")),
    ;
