...
enum class MotifCard(
    ...
    LIGHT(
        ...
        Recipes().common(ConventionalBiomeTags.IN_OVERWORLD),
    ),
    SUN(
    ...
    FIRE(
        ...
        Recipes().common(ConventionalBiomeTags.IN_NETHER),
    ),
    WATER(
    ...
    ENDERMAN(
        ...
        Recipes().common(ConventionalBiomeTags.IN_OVERWORLD).common(ConventionalBiomeTags.IN_NETHER).common(ConventionalBiomeTags.IN_THE_END),
    ),
    CARROT(
