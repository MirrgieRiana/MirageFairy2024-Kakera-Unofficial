...
context(ModContext)
fun registerFeature(biomeSelector: Predicate<BiomeSelectionContext>, step: GenerationStep.Feature, placedFeatureRegistryKey: RegistryKey<PlacedFeature>) = ModEvents.onInitialize {
